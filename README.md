# LightDM nwg greater
This repository is a fork of the LightDM Elephant Greeter, intended to replace sddm greeter on 
the [nwg-iso](https://github.com/nwg-piotr/nwg-iso). This is still a work in progress. 
Please refer to the [original repo](https://github.com/max-moser/lightdm-elephant-greeter).
...
ui-file-location=/usr/local/share/nwg-greeter/nwg-greeter.ui
x-icon-location=/usr/local/share/nwg-greeter/img/X.png
wayland-icon-location=/usr/local/share/nwg-greeter/img/wayland.png
```
